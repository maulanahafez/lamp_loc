...
$.extend(true, DataTable.defaults, {
    dom:
        "<'grid grid-cols-1 md:grid-cols-2 text-sm pt-2'" +
        "<'self-center col-span-2 md:col-span-1'l>" +
        "<'self-center place-self-end col-span-2 md:col-span-1'f>" +
        "<'my-2 col-span-2 border border-gray-200 rounded min-w-full bg-white'tr>" +
        "<'self-center'i>" +
        "<'self-center place-self-end col-span-2 md:col-span-1'p>" +
        ">",
...
$.extend(DataTable.ext.classes, {
    ...
    tailwindcss: {
        ...
        thead: {
            row: "border-b border-gray-100 text-sm",
