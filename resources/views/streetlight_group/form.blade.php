    ...
    <div class="grid grid-cols-1 md:grid-cols-2">
      <div class="">
        <div class="border border-black/20 rounded-sm shadow-sm border-t-2 border-t-secondary">
          <div class="px-4 py-2 border border-b/20">Add New Streetlight Group</div>
          <div class="card">
            <div class="card-body pt-2 pb-6 px-4">
              <form action="{{ route('streetlight_group.store') }}" method="POST">
                @csrf
                <div>
                  ...
                  <input class="input input-sm input-bordered rounded-sm input-secondary w-full" id="code"
                    placeholder="Code" type="text" name="code" value="{{ old('code') }}">
                  @error('code')
                ...
                <div>
                  ...
                  <input class="input input-sm input-bordered rounded-sm input-secondary w-full" id="street"
                    placeholder="Street" type="text" name="street" value="{{ old('street') }}">
                  @error('street')
                    <div class="text-error mt-1">
                      {{ $message }}
                    </div>
